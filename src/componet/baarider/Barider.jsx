...
const Barider = () => {
   ...
   return (
      <div className="max-w-6xl mx-auto py-16 px-6 bg-base-100 rounded-xl shadow flex flex-col lg:flex-row gap-10">
         {/* === Left: Form === */}
         <div className="w-full lg:w-2/3">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
               <div className="grid grid-cols-1 gap-4">
                  ...
                  />
                  {errors.age && <span className="text-red-500 text-sm">You must be 18 or older</span>}
